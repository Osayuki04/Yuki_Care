...
if (isset($_GET['delete'])) {
    ...
    if ($deleteId > 0) {
        ...
        $delete_sql = "DELETE FROM staff WHERE ID = $deleteId";
        $delete_result = mysqli_query($db_handle, $delete_sql);
        
        if ($delete_result) {
            echo "<script>alert('Staff member deleted successfully!'); window.location.href='staff-manage.php';</script>";
        } else {
            echo "<script>alert('Error deleting staff member: " . mysqli_error($db_handle) . "'); window.location.href='staff-manage.php';</script>";
        }
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Manage Staff</h1>
                                <p class="text-gray-600 dark:text-gray-400">Update, delete, and manage staff records</p>
                            </div>
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        ...
                                                        <a href="register.php?edit=<?php echo $staffMember['ID']; ?>" 
    ...
    <script>
        function deleteStaff(staffId) {
            if (confirm('Are you sure you want to delete this staff member? This action cannot be undone.')) {
                ...
                window.location.href = 'staff-manage.php?delete=' + staffId;
            }
        }
    </script>
</body>
