                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900  mb-2">Manage Medications</h1>
                                <p class="text-gray-600 ">Update, delete, and manage medication records</p>
                            </div>
                            <a href="<?= url('admin/pharmacy/register') ?>" class="bg-yuki-600  text-white px-6 py-3 rounded-md hover:bg-yuki-700 hover: transition-colors shadow-lg hover:shadow-xl">
                                            ...
                                            <tr class="hover:bg-gray-50  transition-colors">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        ...
                                                        <a href="<?= url('admin/pharmacy/register') ?>&edit=<?php echo $medication['ID']; ?>" 
    ...
    <script>
        function deleteMedication(medicationId) {
            if (confirm('Are you sure you want to delete this medication? This action cannot be undone.')) {
                ...
                window.location.href = '<?= url('admin/pharmacy/manage') ?>&delete=' + medicationId;
            }
        }
    </script>
